modality = 'bm'
graph = 'gymnasio'
work_dir = f'./work_dirs/dgstgcn/youtube_sub_clips/{modality}'
...
model = dict(
    ...
    cls_head=dict(type='GCNHead', num_classes=17, in_channels=256))

dataset_type = 'PoseDataset'
ann_file = 'data/youtube_sub_clips_pwl.pkl'
mapping = None

train_pipeline = [
    dict(type='PreNormalize3D', align_spine=False),
    dict(type='RandomRot', theta=0.2),
    dict(type='GenSkeFeat', dataset='gymnasio', feats=[modality]),
